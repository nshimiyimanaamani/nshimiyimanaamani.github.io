      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
        ...
        <section class="breadcrumbs-custom" style="background: url(&quot;SiteImages/ts/-1x-1.jpg&quot;); background-size: cover;">
          <div class="container">
            ...
            <p class="heading-1 breadcrumbs-custom-title">Lake kivu</p>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.php">Home</a></li>
              <li class="active">Lake kivu</li>
            </ul>
          </div>
        </section>
        ...
        <div class="container">
          <div class="row row-fix">
            <div class="col-lg-10 col-xl-8">
              <h3>Lake kivu</h3>
              <div class="row row-30">
                <div class="col-md-6"><img src="SiteImages/ts/things-to-do-on-lake-kivu-rwanda.jpg" alt="" width="770" height="680"/>
                    
                </div>
                
                <div class="col-md-6">
                  <p>Part of Africa’s Great Rift Valley, Lake Kivu in the west of Rwanda is surrounded by magnificent
                    mountains and has deep emerald green waters covering a surface area of 2,700 km2. It is Rwanda’s
                    largest lake and the sixth largest in Africa.</p>
                    <p>In the northern edge of Lake Kivu is a town called Gisenyi, an hour’s drive from Volcanoes National
                        Park and the perfect place to relax after gorilla trekking. Once a colonial beach resort of note,
                        Rubavu’s waterfront is lined with fading old mansions, hotels and trendy bars on the lakeshore, ideal
                        for sundowner cocktails. Also the town of Karongi, half way along the lake, is a popular beach resort
                        with hillsides covered in pines and eucalyptus serve as a backdrop to the sparkling lake. At dawn and
                        dusk, the sound of local fisherman singing carries across the water as they paddle in unison.</p>
                        <p>From Rubavu in the north, the Congo Nile Trail extends 227 kilometers of breathtaking landscapes all
                            the way to Rusizi in the south of Lake Kivu. The trail gently curves back and forth as it weaves
                            through hills and mountains beside the lake with eucalyptus trees lining the road and every inch of
                            the hills seemingly terraced with bananas.</p><p>For adventurous travelers, an exciting way to explore Rwanda is a kayaking tour on Lake Kivu, or
                                mountain biking or hiking one of the 6 off-the-beaten path stages of the spectacular Congo Nile Trail.</p><a class="button button-default-outline button-nina button-sm icon novi-icon icon-md-smaller icon-secondary mdi mdi-whatsapp" href="#" id="learn">Know more</a>
                </div>
              </div>
            </div>
          </div>
