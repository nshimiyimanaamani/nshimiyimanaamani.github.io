      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
        ...
        <section class="breadcrumbs-custom" style="background: url(&quot;SiteImages/ts/-1x-1.jpg&quot;); background-size: cover;">
          <div class="container">
            ...
            <p class="heading-1 breadcrumbs-custom-title">3-DAYS NYUNGWE FOREST CHIMPANZEES TOUR</p>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.php">Home</a></li>
              <li class="active">3-DAYS NYUNGWE FOREST CHIMPANZEES TOUR</li>
            </ul>
          </div>
        </section>
...
<a class="button button-default-outline button-nina button-sm icon novi-icon icon-md-smaller icon-secondary mdi mdi-whatsapp" href="contactus.php" id="learn">Contact us</a></p>
            </div>
          </div>
