      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
        ...
        <section class="breadcrumbs-custom" style="background: url(&quot;SiteImages/ts/-1x-1.jpg&quot;); background-size: cover;">
          <div class="container">
            ...
            <p class="heading-1 breadcrumbs-custom-title">NYUNGWE NATIONAL PARK</p>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.php">Home</a></li>
              <li class="active">NYUNGWE NATIONAL PARK</li>
            </ul>
          </div>
        </section>
        ...
        <div class="container">
          <div class="row row-fix">
            <div class="col-lg-10 col-xl-8">
              ...
              <div class="row row-30">
                <div class="col-md-6"><img src="SiteImages/ts/Nyungwe-Forest-National-Park.jpg" alt="" width="770" height="680"/>
                    
                </div>
                
                <div class="col-md-6">
                  <p>One of the oldest rainforests in Africa, Nyungwe is rich in biodiversity and spectacularly beautiful.
                    The mountainous region is teaming with wildlife, including a small population of chimpanzees as well
                    as 12 other species of primate, including the L’Hoest’s monkey endemic to the Albertine Rift.</p>
                    <p>With 15 trails, some of which are detailed here, along with various other activities, visitors can
                        choose to sample the delights of the forest or indulge themselves for a week or more in one of
                        Africa’s most stunning forests.</p>
                        <p>Primate tracking tops most visitor’s list, but it’s worth lingering a little longer for those with time to
                            relax and take in the primal atmosphere.</p><p>Botanists will marvel at the 1,068 plant species and 140 orchids. The birdwatching is among the best
                                in Africa with 322 birds species including Red-collared Babbler and 29 other Albertine Rift Endemic
                                species. Butterflies are also a common sight, with at least 120 species.</p><a class="button button-default-outline button-nina button-sm icon novi-icon icon-md-smaller icon-secondary mdi mdi-whatsapp" href="#" id="learn">Know more</a>
                </div>
              </div>
            </div>
          </div>
