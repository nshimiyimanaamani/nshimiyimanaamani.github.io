                ...
                <div class="col-md-6">
                  <p>Nyandungu Urban Wetland Eco-Tourism Park is composed of ornamental ponds, gallery forests,
                    ...
                    <p>It was built with the idea of supporting innovative approaches to restore and conserve wetland
                      ...
                      wetland.</p><a class="button button-default-outline button-nina button-sm icon novi-icon icon-md-smaller icon-secondary mdi mdi-whatsapp" href="#" id="learn">Know more</a>
                </div>
              </div>
            </div>
          </div>
